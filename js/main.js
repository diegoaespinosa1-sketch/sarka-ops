...
const translations = {
    en: {
        ...
        "service5.desc": "Embedded senior-level support to drive performance today while building operations that can run and sell without you.",
        "service6.title": "Operations Built to Sell",
        "service6.desc": "Full audit + 90-day execution plan to build a business that runs and sells without you. Fix the hidden operational problems that destroy value at exit.",
        ...
        "exitready.desc": "I help owners close the gap between daily operations and a business that is actually transferable and valuable.",
        ...
        "exitready.cta": "Learn more about the Program",
        ...
        "cta.final.subtitle": "Let’s have a short strategy call. I’ll review your current situation and show you the biggest opportunities to build real independence and protect (or increase) value.",
    ...
    es: {
        ...
        "services.desc": "Apoyo directo y sin rodeos para líderes listos para enfrentar las verdades difíciles y construir organizaciones que realmente escalen y entreguen resultados.",
        ...
        "service1.desc": "Construya sistemas de CX que aumenten la retención de clientes, reduzcan la pérdida de clientes y fortalezcan directamente la valoración del negocio para la salida o el crecimiento.",
        "service2.title": "Desarrollo de Procedimientos Operativos Estándar (POE) y Diseño de Procesos",
        "service2.desc": "Convierta el conocimiento que solo reside en las personas en sistemas claros, documentados y escalables que hagan su negocio menos dependiente del propietario y más atractivo para compradores.",
        "service3.title": "Sistemas de Ventas e Implementación de CRM",
        "service3.desc": "Implemente sistemas operativos de ingresos probados (Zoho CRM y Salesforce) que entreguen crecimiento predecible y finanzas limpias listas para debida diligencia.",
        ...
        "service5.title": "Liderazgo Fraccional en CX y Operaciones",
        "service5.desc": "Obtenga apoyo de nivel senior integrado para impulsar el desempeño comercial mientras construye simultáneamente operaciones robustas y preparadas para la salida.",
        "service6.title": "Operaciones listas para venderse",
        "service6.desc": "Auditoría completa de Operaciones Preparadas para la Salida + Plan de 90 Días. Identifique y solucione las debilidades ocultas que destruyen entre el 30% y el 50% del valor del negocio en la salida.",
        "service6.badge": "Oferta Principal",
    ...
    fr: {
        ...
        "services.desc": "Soutien direct et sans fioritures pour les leaders prêts à affronter les réalités et à bâtir des organisations qui scalent et performent réellement.",
        ...
        "service2.title": "Développement de Procédures Opérationnelles Standard (POS) et Design de Processus",
        "service2.desc": "Transformez les connaissances non documentées en systèmes clairs, documentés et évolutifs qui rendent votre entreprise moins dépendante du propriétaire et plus attractive pour les acheteurs.",
        "service3.title": "Systèmes de Vente et Implémentation de CRM",
        ...
        "service5.title": "Leadership Fractionnel en CX et Opérations",
        "service5.desc": "Obtenez un soutien de niveau senior intégré pour piloter la performance commerciale tout en construisant simultanément des opérations robustes et prêtes pour la sortie.",
        "service6.title": "Opérations prêtes à être vendues",
        "service6.desc": "Audit complet des Opérations Prêtes pour la Sortie + Plan sur 90 Jours. Identifiez et corrigez les faiblesses opérationnelles cachées qui détruisent 30 à 50 % de la valeur de l'entreprise à la sortie.",
    ...
    cz: {
        ...
        "service1.desc": "Budujte systémy CX, které zvyšují retenci zákazníků, snižují churn a přímo posilují hodnotu podniku pro odchod nebo růst.",
        "service2.title": "Vývoj standardních operačních postupů (SOP) a návrh procesů",
        "service2.desc": "Převeďte nezdokumentované znalosti do jasných, zdokumentovaných a škálovatelných systémů, které učiní váš podnik méně závislým na majiteli a připraveným pro kupce.",
        ...
        "service4.desc": "Rozviňte své manažery a týmy v první linii, aby podnik mohl fungovat na vysoké úrovni i bez vaší každodenní účasti — nezbytné pro jakýkoliv odchod.",
        "service5.title": "Frakční vedení CX a operací",
        "service5.desc": "Získejte vestavěnou podporu na seniorské úrovni pro řízení komerčního výkonu a současně budujte robustní operace připravené k odchodu.",
        ...
        "service6.badge": "Vlajková nabídka",
        ...
        "service5.desc": "Získejte vestavěnou podporu na seniorské úrovni pro řízení komerčního výkonu a současně budujte robustní operace připravené k odchodu.",
        "service6.title": "Operace připravené k prodeji",
        "service6.desc": "Kompletní audit operací připravených k odchodu + 90denní plán. Identifikujte a opravte skryté slabiny, které ničí 30–50 % hodnoty podniku při odchodu.",
